...
export default function NextCadastro() {
  ...
  return (
    <SafeAreaView style={view.container}>
      <View>
       ...
       <View>
        <Button title="Cadastrar" onPress={() => navigation.navigate('FinishCadastrar')} buttonStyle={InputEntrar.buttonEntrar}/>
      </View> 
